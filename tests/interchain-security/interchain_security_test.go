...
import (
	...
	appConsumer "github.com/strangelove-ventures/daicchain/app"
...
// NewCoordinator initializes Coordinator with interchain security dummy provider and daicchain consumer chain
